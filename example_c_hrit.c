...
int main(int argc, char *argv[]) {
	...
	// If argv[5] == 1 then print extra info on pixel (lat/lon etc)
	int printmore = atoi(argv[6]);
	...
	/* Read and preprocess the data.  Note: the last four arguments are unused
	   ...
	   of the arguments. */
	if (seviri_read_and_preproc_hrit(indir,timeslot,satnum, &preproc, inbands.nbands, inbands.band_ids,
	band_units, SEVIRI_BOUNDS_LINE_COLUMN,line0, line1, column0, column1,0., 0., 0., 0., 0))
	{
