...
module seviri_native_util
   ...
   public :: seviri_preproc_t, &
     ...
     integer, parameter, public :: SEVIRI_UNIT_RAD            = 0
     integer, parameter, public :: SEVIRI_UNIT_BRF            = 1
     integer, parameter, public :: SEVIRI_UNIT_BT             = 2
   ...
   type :: seviri_preproc_t_f90
     ...
     real(kind=4), pointer :: lon(:, :)
     real(kind=4), pointer :: sza(:, :)
     real(kind=4), pointer :: saa(:, :)
     real(kind=4), pointer :: vza(:, :)
     real(kind=4), pointer :: vaa(:, :)
